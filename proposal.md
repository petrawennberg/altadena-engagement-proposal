...
**Today, recovery feels like attempting to sip water from eight fire hoses on full blast. It’s impossible.** *(Mike Tuccillo, Altadena resident & block captain, May 15, 2026)*
...
- **Acceptance criteria:**
  - 2-hour training session covering: facilitation basics, trauma-informed engagement, decision-record use, Brown Act guardrails
...
- **User story:** *As a new block captain, I want training and someone to call if it gets hard, so I’m not on my own.*
...
- **User story:** *As a CAPS member or resident, I want to see what input each project is getting, so we can coordinate across agencies and track follow-through.*
...
- [ ] **Outreach & circulation** — share the plan with EFC, ACONA, broader CAPS coalition, ATC, partners, and community
